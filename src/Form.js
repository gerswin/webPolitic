                    ...
                    <Col xs="6" sm="6" md="6">
                        <Form
                            onSubmit={({address,cc,name,phone,location,email}) => {
                                const that = this;
                                const parent = localStorage.getItem("selectedUser") !== null ? JSON.parse(localStorage.getItem("selectedUser")).email :null
                                if (parent==null){
                                    that.props.alert.show("Debes seleccionar un ! ");
                                    return
                                }
                                db.collection('personas')
                                    ...
                                    .set({
                                        ...
                                        address: address,
                                        role: currentUser,
                                        master: localStorage.getItem("currentMaster"),
