...
class Avatar extends Component {
  ...
  render() {
    ...
    const {userCount,userNetCount} = this.props;
    return (
      <Row style={styles.margin}>
        ...
        <Col >
          ...
          <div style={styles.subtitle}>
            ...
            <p style={styles.p}>{userCount} {userCount > 1 ? "Registros" : userCount === 0 ?  "Registros" :  "Registro" } </p>
            <p style={styles.p}>{userNetCount} {userNetCount > 1 ? "Voluntarios" : userCount === 0 ?  "Voluntarios" :  "Voluntario"  } en Red</p>
